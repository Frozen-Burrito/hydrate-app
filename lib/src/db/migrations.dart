...
class SQLiteMigrator {
  ...
  static final Map<int, List<String>> migrations = {
    ...
    14: [
      ...
      '''INSERT INTO ${ActivityType.tableName} VALUES (0, 5.0, 4.3, 7);''',
      '''INSERT INTO ${ActivityType.tableName} VALUES (1, 8.0, 7.0, 8);''',
      '''INSERT INTO ${ActivityType.tableName} VALUES (2, 11.0, 7.5, 1);''',
      '''INSERT INTO ${ActivityType.tableName} VALUES (3, 0.0, 9.8, 82);''',
      '''INSERT INTO ${ActivityType.tableName} VALUES (4, 0.0, 7.0, 29);''',
      '''INSERT INTO ${ActivityType.tableName} VALUES (5, 0.0, 6.5, 12);''',
      '''INSERT INTO ${ActivityType.tableName} VALUES (6, 0.0, 4.0, 89);''',
      '''INSERT INTO ${ActivityType.tableName} VALUES (7, 0.0, 7.8, 24);''',
      '''INSERT INTO ${ActivityType.tableName} VALUES (8, 0.0, 1.3, 100);''',
    ],
    17: [
      '${SQLiteKeywords.dropTableIfExists} ${ActivityRecord.tableName}',
      '${SQLiteKeywords.dropTableIfExists} ${ActivityType.tableName}',
